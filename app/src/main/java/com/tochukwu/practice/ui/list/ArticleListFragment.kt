...
import com.tochukwu.practice.databinding.ArticleListFragmentBinding
import com.tochukwu.practice.util.DEFAULT_LANGUAGE
import com.tochukwu.practice.util.PREF_LANGUAGE_KEY
...
class ArticleListFragment : Fragment(){
    ...
    private fun navigateToSettings(){
        findNavController().navigate(
            ArticleListFragmentDirections.actionArticleListFragmentToSettingsFragment()
        )
    }
    ...
    private fun displayCategoriesPicker(){
        ...
        MaterialAlertDialogBuilder(requireActivity(), R.style.NewsMaterialAlertDialog)
